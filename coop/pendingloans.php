...
<body>
    ...
    <div class="content">
        ...
        <?php
            if (isset($role) && ($role === 'Administrator' || $role === 'Accountant')) {
        ?>
                <a href="activeloans.php"><button style="text-decoration: none;" class="userbutton">Active Loans</button></a>
        <?php } ?>
        <?php
            $sql_loan = "SELECT * FROM Loans Where Status = 'Pending'";
            ...
            ?>
                ...
                <table>
                    ...
                    <th><label style="color: white;">Months</label></th>
                    ...
                    <tr>
                        ...
                        <td><a href="disapprove_loan.php?loan_id=<?php echo $row['Loan_id']; ?>" onclick="return confirm('Are you sure you want to disapprove of this loan?');"><button>Disapprove</button></a></td>
                    </tr>
                    <?php
                    }
                    ?>
                ...
                <?php
                        ...
                        echo "<br> No Pending Loans found";
                    }
                ?>
