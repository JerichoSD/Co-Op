...
<body>
    ...
    <div class="content">
        <label class='pagetitle';>Transactions</label>
        <br>
        <?php
            $sql_pending = "SELECT * FROM Transactions WHERE Status = 'Pending'";
            ...
            ?>
                ...
                <table>
                    ...
                    <th><label style="color: white;">Member Name</label></th>
                    <th><label style="color: white;">Transaction Type</label></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="approve_transaction.php" method="POST" style="display:inline;">
                                <input type="hidden" name="transaction_id" value="<?php echo $row['Transaction_id']; ?>">
                                <button type="submit">Approve</button>
                            </form>
                        </td>
                        <td><a href="disapprove_transaction.php?transaction_id=<?php echo $row['Transaction_id']; ?>" onclick="return confirm('Are you sure you want to disapprove of this Transaction?');"><button>Disapprove</button></a></td>
                    </tr>
                    <?php
                    }
                    ?>
                ...
                <?php
                    $sql_Completed = "SELECT * FROM Transactions WHERE Status = 'Completed'";
                    ...
                    ?>
                        ...
                        <table>
                            <th><label style="color: white;">Transaction ID</label></th>
                            <th><label style="color: white;">Accountant_Name</label></th>
                            <th><label style="color: white;">Member Name</label></th>
                            <th><label style="color: white;">Transaction Type</label></th>
                            <th><label style="color: white;">Amount</label></th>
                            <th><label style="color: white;">Date</label></th>
                            <?php
                                while ($row = mysqli_fetch_array($result_Completed)) {
                            ?>
                            <tr>
                                <td style="text-align: center;"><?php echo $row["Transaction_id"]; ?></td>
                                <td><?php echo $row["Accountant_Name"]; ?></td>
                                <td><?php echo $row["Member_Name"]; ?></td>
                                <td><?php echo $row["Transaction_Type"]; ?></td>
                                <td><?php echo $row["Amount"]; ?></td>
